...
- kevinluzbetak@gmail.com

### Overview
Build a data pipeline that handles both structured and unstructured data, processes it, and allows querying via embeddings for a Retriever-Augmented Generation (RAG) use case. The solution should be wel
